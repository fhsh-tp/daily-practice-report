# page-context-dependency Specification

## Purpose

Defines the shared page context dependency that injects sidebar variables into all teacher and admin page handlers.
